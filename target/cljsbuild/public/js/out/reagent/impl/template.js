...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20417__auto__,writer__20418__auto__,opt__20419__auto__){
return cljs.core._write.call(null,writer__20418__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__19819__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__19819__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__19819__auto__)){
return or__19819__auto__;
} else {
...
var G__36790 = o;
(G__36790[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__36791__delegate = function (args){
...
while (G__36792__i < G__36792__a.length) {G__36792__a[G__36792__i] = arguments[G__36792__i + 0]; ++G__36792__i;}
  args = new cljs.core.IndexedSeq(G__36792__a,0);
} 
return G__36791__delegate.call(this,args);};
...
return G__36791__delegate(args);
});
...
var old_36794 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_36794))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_36794)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__19807__auto__ = (node === document.activeElement);
if(and__19807__auto__){
var and__19807__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__19807__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__36797 = jsprops;
(G__36797["defaultValue"] = value);

(G__36797["onChange"] = ((function (G__36797,v,value,on_change){
return (function (p1__36795_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__36795_SHARP_);
});})(G__36797,v,value,on_change))
);
...
var vec__36799 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__36799,(0),null);
var id = cljs.core.nth.call(null,vec__36799,(1),null);
var class$ = cljs.core.nth.call(null,vec__36799,(2),null);
...
var temp__4659__auto__ = (function (){var G__36803 = cljs.core.meta.call(null,v);
if((G__36803 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__36803);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__36805_36806 = v;
var G__36805_36807__$1 = (((G__36805_36806 == null))?null:reagent.impl.template.key_from_vec.call(null,G__36805_36806));
if((G__36805_36807__$1 == null)){
} else {
(jsprops["key"] = G__36805_36807__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__36810 = cljs.core.meta.call(null,argv);
if((G__36810 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__36810);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__36811 = (((jsprops == null))?{}:jsprops);
(G__36811["key"] = key);
...
var G__36812 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__36812;
continue;
}
} else {
...
var n__20722__auto___36813 = a.length;
var i_36814 = (0);
while(true){
if((i_36814 < n__20722__auto___36813)){
(a[i_36814] = reagent.impl.template.as_element.call(null,(a[i_36814])));
...
var a = cljs.core.into_array.call(null,s);
var n__20722__auto___36816 = a.length;
var i_36817 = (0);
while(true){
if((i_36817 < n__20722__auto___36816)){
var val_36818 = (a[i_36817]);
if((cljs.core.vector_QMARK_.call(null,val_36818)) && ((reagent.impl.template.key_from_vec.call(null,val_36818) == null))){
(o["no-key"] = true);
} else {
}

(a[i_36817] = reagent.impl.template.as_element.call(null,val_36818));

var G__36819 = (i_36817 + (1));
i_36817 = G__36819;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__19807__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__19807__auto__){
return (ctx["no-key"]);
} else {
return and__19807__auto__;
...
var G__36821 = (cljs.core.count.call(null,argv) - first_child);
switch (G__36821) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__36821){
