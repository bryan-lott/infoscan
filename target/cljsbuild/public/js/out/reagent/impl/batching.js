...
var or__19819__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__19819__auto__)){
return or__19819__auto__;
} else {
var or__19819__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__19819__auto____$1)){
return or__19819__auto____$1;
} else {
var or__19819__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__19819__auto____$2)){
return or__19819__auto____$2;
} else {
var or__19819__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__19819__auto____$3)){
return or__19819__auto____$3;
} else {
...
var n__20722__auto__ = a.length;
var i = (0);
while(true){
if((i < n__20722__auto__)){
var c_36726 = (a[i]);
if(cljs.core.truth_((c_36726["cljsIsDirty"]))){
(c_36726["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__20417__auto__,writer__20418__auto__,opt__20419__auto__){
return cljs.core._write.call(null,writer__20418__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__36730 = c;
var G__36730__$1 = (((G__36730 == null))?null:(G__36730["props"]));
if((G__36730__$1 == null)){
return null;
} else {
return (G__36730__$1["argv"]);
}
});
...
var G__36732_36733 = (c["cljsRatom"]);
if((G__36732_36733 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__36732_36733);
}
